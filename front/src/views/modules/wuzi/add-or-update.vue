    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="原价" prop="wuziOldMoney">
                       <el-input v-model="ruleForm.wuziOldMoney"
                                 placeholder="原价" clearable  :readonly="ro.wuziOldMoney"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="原价" prop="wuziOldMoney">
                           <el-input v-model="ruleForm.wuziOldMoney"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="现价" prop="wuziNewMoney">
                       <el-input v-model="ruleForm.wuziNewMoney"
                                 placeholder="现价" clearable  :readonly="ro.wuziNewMoney"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="现价" prop="wuziNewMoney">
                           <el-input v-model="ruleForm.wuziNewMoney"
