        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '捐赠标题' : ''">
                         <el-input prefix-icon="el-icon-search" v-model="searchForm.wuzijuanzengName" placeholder="捐赠标题" clearable></el-input>
                     </el-form-item>
         
                     <el-form-item :label="contents.inputTitle == 1 ? '捐赠类型' : ''">
                        <el-select v-model="searchForm.wuzijuanzengTypes" placeholder="请选择捐赠类型">
                            <el-option label="=-请选择-=" value=""></el-option>
                            <el-option
                               v-for="(item,index) in wuzijuanzengTypesSelectSearch"
                               v-bind:key="index"
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/shequwuzijiaoyipingtai/upload/wuzijuanzengMuBan.xls"
                        >批量导入物资捐赠数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('wuzijuanzeng','导入导出')"
            ...
            <div class="table-content">
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                   prop="wuzijuanzengName"
                                   header-align="center"
                                   label="捐赠标题">
                        <template slot-scope="scope">
                            {{scope.row.wuzijuanzengName}}
                        </template>
                    </el-table-column>
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                      prop="wuzijuanzengTypes"
                                      header-align="center"
                                      label="捐赠类型">
                        <template slot-scope="scope">
                            {{scope.row.wuzijuanzengValue}}
                        </template>
                    </el-table-column>
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                      prop="wuzijuanzengNumb"
                                      header-align="center"
                                      label="捐赠数量">
                        <template slot-scope="scope">
                            {{scope.row.wuzijuanzengNumb}}
                        </template>
                    </el-table-column>
...
<script>
    ...
    //级联表下拉框搜索条件
    //当前表下拉框搜索条件
              wuzijuanzengTypesSelectSearch : [],
            form:{
                id : null,
                wuzijuanzengName : null,
                wuzijuanzengTypes : null,
                yonghuId : null,
                wuzijuanzengNumb : null,
                insertTime : null,
                wuzijuanzengContent : null,
                createTime : null,
            },
            dataList: [],
            pageIndex: 1,
            ...
            json_fields: {
                //级联表字段
                     ...
                     '余额': 'newMoney',
                //本表字段
                     '捐赠标题': "wuzijuanzengName",
                     '捐赠类型': "wuzijuanzengValue",
                     '捐赠数量': "wuzijuanzengNumb",
                     '添加时间': "insertTime",
            },
        ...
        methods: {
            chartDialog() {
                ...
                let params = {
                    ...
                    thisTable : {//当前表
                        tableName :'wuzijuanzeng',//当前表表名,
                        sumColum : 'wuzijuanzeng_number', //求和字段
                        date : 'insert_time',//分组日期字段
                        // string : 'wuzijuanzeng_name',//分组字符串字段
                        // types : 'wuzijuanzeng_types',//分组下拉框字段
                    },
                    // joinTable : {//级联表（可以不存在）
                ...
                //         groupColumn: "wuzijuanzeng_types",
                //     }
                //     this.$http({
            ...
            getDataList() {
                ...
                if (this.searchForm.wuzijuanzengName!= '' && this.searchForm.wuzijuanzengName!= undefined) {
                    params['wuzijuanzengName'] = '%' + this.searchForm.wuzijuanzengName + '%'
                }
         
                if (this.searchForm.wuzijuanzengTypes!= '' && this.searchForm.wuzijuanzengTypes!= undefined) {
                    params['wuzijuanzengTypes'] = this.searchForm.wuzijuanzengTypes
                }
                ...
                //填充下拉框选项
                this.$http({
                    url: "dictionary/page?dicCode=wuzijuanzeng_types&page=1&limit=100",
                    method: "get",
                }).then(({data}) => {
                    if(data && data.code === 0){
                        this.wuzijuanzengTypesSelectSearch = data.data.list;
                    }
                });
            },
            //每页数
