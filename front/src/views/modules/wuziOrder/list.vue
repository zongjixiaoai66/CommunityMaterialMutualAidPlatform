        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '订单号' : ''">
                         <el-input prefix-icon="el-icon-search" v-model="searchForm.wuziOrderUuidNumber" placeholder="订单号" clearable></el-input>
                     </el-form-item>
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/shequwuzijiaoyipingtai/upload/wuziOrderMuBan.xls"
                        >批量导入物资订单数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('wuziOrder','导入导出')"
            ...
            <div class="table-content">
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                      prop="wuziOrderPaymentTypes"
                                      header-align="center"
                                      label="支付类型">
                        <template slot-scope="scope">
                            {{scope.row.wuziOrderPaymentValue}}
                        </template>
                    </el-table-column>
            ...
            <el-button v-if="isAuth('wuziOrder','订单') && scope.row.wuziOrderTypes == 101 && sessionTable=='yonghu' && userId==scope.row.yonghuId" type="primary" icon="el-icon-sold-out" size="mini" @click="refund(scope.row.id)">退款</el-button>
...
&& sessionTable=='users'" type="primary" icon="el-icon-reading" size="mini"
            ...
            >派送</el-button>
            <el-button v-if="isAuth('wuziOrder','订单') && scope.row.wuziOrderTypes == 103 && sessionTable=='yonghu' && userId==scope.row.yonghuId" type="primary" icon="el-icon-reading" size="mini" @click="receiving(scope.row.id)">收货</el-button>
    ...
    //当前表下拉框搜索条件
            ...
            json_fields: {
                //级联表字段
                     ...
                     '余额': 'newMoney',
                //本表字段
                     '订单号': "wuziOrderUuidNumber",
                     '购买数量': "buyNumber",
                     '实付价格': "wuziOrderTruePrice",
                     '订单类型': "wuziOrderValue",
                     '支付类型': "wuziOrderPaymentValue",
                     '订单创建时间': "insertTime",
            },
