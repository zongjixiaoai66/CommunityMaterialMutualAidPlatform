    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="订单号" prop="wuziOrderUuidNumber">
                       <el-input v-model="ruleForm.wuziOrderUuidNumber"
                                 placeholder="订单号" clearable  :readonly="ro.wuziOrderUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="订单号" prop="wuziOrderUuidNumber">
                           <el-input v-model="ruleForm.wuziOrderUuidNumber"
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="支付类型" prop="wuziOrderPaymentTypes">
                        <el-select v-model="ruleForm.wuziOrderPaymentTypes" :disabled="ro.wuziOrderPaymentTypes" placeholder="请选择支付类型">
                            <el-option
                                v-for="(item,index) in wuziOrderPaymentTypesOptions"
                                v-bind:key="item.codeIndex"
                                :label="item.indexName"
                                :value="item.codeIndex">
                            </el-option>
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="支付类型" prop="wuziOrderPaymentValue">
                        <el-input v-model="ruleForm.wuziOrderPaymentValue"
    ...
    export default {
        data() {
            return {
                ...
                ruleForm: {
                    ...
                    wuziOrderTruePrice: '',
                    wuziOrderTypes: '',
                    wuziOrderPaymentTypes: '',
                    insertTime: '',
                },
                wuziOrderTypesOptions : [],
                wuziOrderPaymentTypesOptions : [],
                addressOptions : [],
                wuziOptions : [],
                yonghuOptions : [],
                rules: {
        ...
        created() {
            ...
            //获取下拉框信息
                ...
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=wuzi_order_payment_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.wuziOrderPaymentTypesOptions = data.data.list;
                    }
                });
